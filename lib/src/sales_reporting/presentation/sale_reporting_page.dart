...
class _SaleReportingPageState extends State<SaleReportingPage> with AutomaticKeepAliveClientMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: MultiBlocProvider(
        providers: [
          BlocProvider<SalesReportingBloc>.value(
            value: BlocProvider.of<SalesReportingBloc>(context)..add(SalesReportingEvent.onFetchReport(branch: context.read<AccountBloc>().state.profile?.branch)),
          )
        ],
